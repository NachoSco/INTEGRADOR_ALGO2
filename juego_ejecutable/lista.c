...
// Función para cambiar el puntero de un elemento en una posición específica
int cambiar_elemento(lista_t *lista, unsigned posicion, void *nuevo_elemento) {
    if (posicion >= lista->longitud) {
        return -1;  // Retorna -1 si la posición está fuera de los límites de la lista
    }
    ...
    nodo_actual->elemento = nuevo_elemento;
    return 0;  // Retorna 0 si se cambió el elemento exitosamente
}
